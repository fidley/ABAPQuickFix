...
public class Clear extends StatementAssist implements IAssistRegex {
	...
	private String MatchPattern = "(?s)clear\\s*:*\\s+(.*)";
	...
	public Clear(IQuickAssistInvocationContext context) {
		super(context);
	}
	...
	public String getAssistShortText() {
		return "Combine CLEAR statements";
	}
