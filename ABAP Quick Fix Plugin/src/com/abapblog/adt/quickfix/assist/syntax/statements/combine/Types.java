...
public class Types extends StatementAssistRegex implements IAssistRegex {
	...
	private String MatchPattern = "(?s)\\s*types\\s*:*\\s+(.*)";
	...
	public Types(IQuickAssistInvocationContext context) {
		super(context);
	}
	...
	public String getAssistShortText() {
		return "Combine TYPES statements";
	}
