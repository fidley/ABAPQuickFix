...
public class ReadTableTransportingNoFieldsIndex extends StatementAssistRegex implements IAssistRegex {

	private static final String NOT = "NOT";
	private static final String CODE = "Code";

	public ReadTableTransportingNoFieldsIndex(IQuickAssistInvocationContext context) {
		super(context);
	}

	@Override
	public String getMatchPattern() {
		return IReadTablePatterns.readTableTransportingNoFieldsIndex;
	}

	@Override
	public String getReplacePattern() {
		return IReadTablePatterns.replaceReadTableTransportingNoFieldsIndex;
	}
