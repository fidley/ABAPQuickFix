...
public class AppendWithHeaderLineToAppendValueTo extends StatementAssist implements IAssistRegex {

	private static final String BeginningOfStatement = "APPEND VALUE #(  ";
	...
	private String MatchPatternAppendTo = "(?s)append\\s*(.*)to\\s*(.*)";
	private String MatchPattern = "(?s)append\\s*(.*)\\s*";
	...
	public AppendWithHeaderLineToAppendValueTo() {
		super();
	}
	...
	public boolean canAssist() {
		if (CodeReader.CurrentStatement.matchPattern(MatchPatternAppendTo)) {
			return false;
		}
