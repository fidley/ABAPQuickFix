...
public class ReadTableAssigningWithKey extends StatementAssistRegex implements IAssistRegex {

	public ReadTableAssigningWithKey(IQuickAssistInvocationContext context) {
		super(context);
	}
