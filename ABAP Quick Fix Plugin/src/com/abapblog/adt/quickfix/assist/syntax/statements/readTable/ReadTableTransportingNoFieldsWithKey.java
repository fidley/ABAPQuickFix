...
public class ReadTableTransportingNoFieldsWithKey extends StatementAssistRegex implements IAssistRegex {

	private static final String NOT = "NOT";
	private static final String CODE = "Code";

	public ReadTableTransportingNoFieldsWithKey(IQuickAssistInvocationContext context) {
		super(context);
	}

	@Override
	public String getMatchPattern() {
		return IReadTablePatterns.readTableTransportingNoFieldsWithKey;
	}

	@Override
	public String getReplacePattern() {
		return IReadTablePatterns.replaceReadTableTransportingNoFieldsWithKey;
	}
