...
public class Check extends StatementAssistRegex implements IAssistRegex {
	...
	private String MatchPattern = "(?s)\\s*check\\s*:*\\s+(.*)";
	...
	public Check(IQuickAssistInvocationContext context) {
		super(context);
	}
	...
	public String getAssistShortText() {
		return "Combine CHECK statements";
	}
