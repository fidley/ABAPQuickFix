...
public class Constants extends StatementAssistRegex implements IAssistRegex {
	...
	private String MatchPattern = "(?s)\s+constants\\s*:*\\s+(.*)";
	...
	public Constants(IQuickAssistInvocationContext context) {
		super(context);
	}
	...
	public String getAssistShortText() {
		return "Combine CONSTANTS statements";
	}
