...
public class Refresh extends StatementAssistRegex implements IAssistRegex {
	...
	private String MatchPattern = "(?s)\s+refresh\\s*:*\\s+(.*)";
	...
	public Refresh(IQuickAssistInvocationContext context) {
		super(context);
	}
	...
	public String getAssistShortText() {
		return "Combine REFRESH statements";
	}
