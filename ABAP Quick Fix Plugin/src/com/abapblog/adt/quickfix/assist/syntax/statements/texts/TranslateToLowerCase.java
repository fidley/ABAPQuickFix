...
public class TranslateToLowerCase extends StatementAssistRegex {

	private static final String TOKEN = "TRANSLATE";
	private static final String MatchPattern = "TRANSLATE\\s*(\\w*)\\s*TO\\s*LOWER\\s*CASE";
	private static final String ReplacementPattern = "$1 = to_lower( $1 )";

	@Override
	public String getAssistShortText() {
		return "Replace TRANSLATE x TO LOWER CASE with X = to_lower( x )";
	}
