...
public class LoopAtItabWithHeaderLineAsRefInto extends StatementAssist {
	...
	public LoopAtItabWithHeaderLineAsRefInto() {
		super();
	...
	public String getChangedCode() {
		...
		updatedCode = updatedCode.replaceAll(internalTableName + "-", "ref_" + internalTableName + "->");
		updatedCode = updatedCode.replaceFirst(internalTableName,
				internalTableName + " REFERENCE INTO DATA(ref_" + internalTableName + ")");
	...
	public String getAssistShortText() {
		return "Replace Loop At ITAB with Header Line with Loop at Ref Into";
	}

	@Override
	public String getAssistLongText() {
		return "Replaces the old fashion LOOP AT ITAB. into LOOP AT ITAB REFERENCE INTO, and replaces all "
				+ " occurences of the ITAB in the loop with reference variable.\n MODIFY and DELETE statemens are commented out.";
	}
