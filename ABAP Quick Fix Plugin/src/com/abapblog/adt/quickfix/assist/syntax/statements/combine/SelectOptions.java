...
public class SelectOptions extends StatementAssistRegex implements IAssistRegex {
	...
	private String MatchPattern = "(?s)select-options\\s*:*\\s+(.*)";
	...
	public SelectOptions(IQuickAssistInvocationContext context) {
		super(context);
	}
