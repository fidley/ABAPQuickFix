...
public class AlignTypes extends StatementAssist {

	protected String[] operatorNames = { "TYPE", "LIKE" };
	...
	public String getAssistLongText() {
		...
		return "Aligns position of TYPE / LIKE statement.<br>" + "<strong>Works only on selected code</strong><br>";
	}
